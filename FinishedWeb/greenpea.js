...
function startGame() {
  ...
  myGameArea.start();
  myGamePiece = new component(50, 50, "img/hero.gif",225,651, "image");
  tiger[0] = new component(60, 60, "img/Tiger.gif", 0, 400, "enemy");
  tiger[1] = new component(60, 60, "img/Tiger.gif", 0, 200, "enemy");
  virus[0] = new component(50, 50, "img/New_Virus_clone.gif", 75, 50, "enemy");
  virus[1] = new component(50, 50, "img/New_Virus_clone_2.gif", 0, 250, "enemy");
  for (let i = 0; i < 5; i++){
    meat[i] = new component(30, 30, "img/Meat.gif", 0, 0, "food");
  }
  for (let i = 0; i < 3; i++){
    veggie[i] = new component(30, 30, "img/MiniTree.gif", 0, 0, "food");
  }
}
...
if (virus[0].x == 75 && virus[0].y == 50) {virus[0].speedX = 0; virus[0].speedY = 5}//first virus
  ...
  if (current >= 100){
      ...
      if (veggcount > meatcount){
        ...
        document.body.style.backgroundImage = "url('img/red1.png')";
